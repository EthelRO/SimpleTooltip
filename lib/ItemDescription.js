...
(function (mw, $) {
    ...
    function formatText(description, itemId) {
        ...
        // Converter os marcadores de divisores em divs de separação com múltiplas linhas
        formattedText = formattedText
            .replace(/---DIVIDER---/g, '</p><div class="hr-divider-container"><div class="hr-divider"></div><div class="hr-divider"></div><div class="hr-divider"></div></div><p class="item-description">')
            .replace(/<br \/>\s*<\/p>/g, '</p>')
        ...
        itemTooltips.forEach((el, index) => {
            ...
            try {
                ...
                el.addEventListener('mouseenter', () => {
                    ...
                    // Adicionar evento de mouseenter ao tooltip para evitar que ele seja fechado
                    ...
                    // Adicionar evento de mouseleave ao tooltip
                ...
                el.addEventListener('mouseleave', () => {
                    ...
                    // Não remover imediatamente, mas definir um timeout
                    if (!tooltipTimeout) {
                        tooltipTimeout = setTimeout(() => {
                            ...
                            tooltipTimeout = null;
                        }, 300); // Esperar 300ms antes de remover
                    }
                });
            } catch (e) {
