...
(function (mw, $) {
    ...
    function formatText(description, itemId) {
        ...
        formattedText = formattedText.replace(/(-{3,})/g, '<hr class="tooltip-divider">');
    ...
    mw.libs.ItemDescription.init = function() {
        ...
        itemTooltips.forEach((el, index) => {
            ...
            try {
                ...
                // Variável global para controle do tooltip atual
                ...
                el.addEventListener('mouseenter', () => {
                    ...
                    // Se já existir um tooltip, remover
                    if (currentTooltip) {
                    ...
                    // Adicionar evento de mouseenter ao tooltip para evitar que ele feche
                    ...
                    // Adicionar evento de mouseleave ao tooltip para fechá-lo quando o mouse sair
                    tooltipContainer.addEventListener('mouseleave', () => {
                        tooltipTimeout = setTimeout(() => {
                            if (currentTooltip === tooltipContainer) {
                                tooltipContainer.remove();
                                currentTooltip = null;
                            }
                            tooltipTimeout = null;
                        }, 500); // 500ms de delay para evitar fechamento acidental
                    });
                });
                ...
                el.addEventListener('mouseleave', () => {
                    ...
                    // Definir timeout para remover o tooltip após 500ms
                    tooltipTimeout = setTimeout(() => {
